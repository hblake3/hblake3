...
- 🔭 I’m currently working on [a personal blog web application](https://github.com/hblake3/ReaectBlog). This project is being created to showcase my ability to create a CRUD application using PostgreSQL as a backend with API connections to Supabase. It is still a work in progress, but you can view the live page [here](https://hblake3.github.io/Blog/)!
